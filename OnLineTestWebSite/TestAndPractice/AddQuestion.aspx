...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="Server">
    ...
    <div class="row">
        <label class="title  QT" id="lab_questiontitle">试题题目<label style="color:red">*</label></label><textarea class="content" id="QuestionTitle" cols="20" rows="2">答案区域请用英文输入"()"一对小括号占位</textarea></div>
    <div class="row">
        <label class="title QT">选项A<label style="color:red">*</label></label><textarea class="content QC" id="AnswerA" cols="20" rows="2"></textarea></div>
    <div class="row">
        <label class="title QT">选项B<label style="color:red">*</label></label><textarea class="content QC" id="AnswerB" cols="20" rows="2"></textarea></div>
    <div class="row">
        <label class="title QT">选项C<label style="color:red">*</label></label><textarea class="content QC" id="AnswerC" cols="20" rows="2"></textarea></div>
    <div class="row">
        <label class="title QT">选项D<label style="color:red">*</label></label><textarea class="content QC" id="AnswerD" cols="20" rows="2"></textarea></div>
    <div class="row">
    ...
    <div class="row">
        <label class="title">试题参考图</label><input id="ImageAddress" class="content" type="file" />请确保上传图像不超过1M</div>
    <div class="row">
    ...
    <div class="row">
        <label class="title">作者<label style="color:red">*</label></label><label class="content" id="UserName"></label></div>
    <div class="row">
    ...
    <div class="row" id="btnAdd">新增</div>
