...
{
	/// <summary>
	/// 数据访问类:SubjectServers
	/// </summary>
	public partial class SubjectServers
	{
		public SubjectServers()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("SubjectId", "Subject"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(OnLineTest.Model.Subject model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Subject(");
			strSql.Append("SubjectName,SubjectRemark,IsVerified)");
			strSql.Append(" values (");
			strSql.Append("@SubjectName,@SubjectRemark,@IsVerified)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@SubjectName", SqlDbType.NVarChar,50),
					new SqlParameter("@SubjectRemark", SqlDbType.Text),
					new SqlParameter("@IsVerified", SqlDbType.Bit,1)};
			parameters[0].Value = model.SubjectName;
			parameters[1].Value = model.SubjectRemark;
			parameters[2].Value = model.IsVerified;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(OnLineTest.Model.Subject model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Subject set ");
			strSql.Append("SubjectName=@SubjectName,");
			strSql.Append("SubjectRemark=@SubjectRemark,");
		...
		/// 批量删除数据
		/// </summary>
		public bool DeleteList(string SubjectIdlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Subject ");
			strSql.Append(" where SubjectId in ("+SubjectIdlist + ")  ");
		...
		/// 得到一个对象实体
		/// </summary>
		public OnLineTest.Model.Subject GetModel(int SubjectId)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SubjectId,SubjectName,SubjectRemark,IsVerified from Subject ");
			strSql.Append(" where SubjectId=@SubjectId");
			SqlParameter[] parameters = {
					new SqlParameter("@SubjectId", SqlDbType.Int,4)
			};
			...
			OnLineTest.Model.Subject model=new OnLineTest.Model.Subject();
		...
		/// 得到一个对象实体
		/// </summary>
		public OnLineTest.Model.Subject DataRowToModel(DataRow row)
		{
			OnLineTest.Model.Subject model=new OnLineTest.Model.Subject();
			if (row != null)
			{
				...
				if(row["SubjectRemark"]!=null)
				{
					model.SubjectRemark=row["SubjectRemark"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select SubjectId,SubjectName,SubjectRemark,IsVerified ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" SubjectId,SubjectName,SubjectRemark,IsVerified ");
			strSql.Append(" FROM Subject ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.SubjectId desc");
			}
