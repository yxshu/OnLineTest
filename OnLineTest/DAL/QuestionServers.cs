...
namespace OnLineTest.DAL
{
    ...
    public partial class QuestionServers
    {
        ...
        public int Add(OnLineTest.Model.Question model)
        {
            ...
            strSql.Append("QuestionTitle,AnswerA,AnswerB,AnswerC,AnswerD,CorrectAnswer,ImageAddress,DifficultyId,UserId,UpLoadTime,VerifyTimes,IsVerified,IsDelte,IsSupported,IsDeSupported,PaperCodeId,TextBookId,ChapterId,PastExamPaperId,PastExamQuestionId,Explain,Remark)");
            ...
            parameters[20].Value = model.Explain;
        ...
        public OnLineTest.Model.Question GetModel(int QuestionId)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 QuestionId,QuestionTitle,AnswerA,AnswerB,AnswerC,AnswerD,CorrectAnswer,ImageAddress,DifficultyId,UserId,UpLoadTime,VerifyTimes,IsVerified,IsDelte,IsSupported,IsDeSupported,PaperCodeId,TextBookId,ChapterId,PastExamPaperId,PastExamQuestionId,Explain,Remark from Question ");
            strSql.Append(" where QuestionId=@QuestionId");
            SqlParameter[] parameters = {
					new SqlParameter("@QuestionId", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select QuestionId,QuestionTitle,AnswerA,AnswerB,AnswerC,AnswerD,CorrectAnswer,ImageAddress,DifficultyId,UserId,UpLoadTime,VerifyTimes,IsVerified,IsDelte,IsSupported,IsDeSupported,PaperCodeId,TextBookId,ChapterId,PastExamPaperId,PastExamQuestionId,Explain,Remark ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" QuestionId,QuestionTitle,AnswerA,AnswerB,AnswerC,AnswerD,CorrectAnswer,ImageAddress,DifficultyId,UserId,UpLoadTime,VerifyTimes,IsVerified,IsDelte,IsSupported,IsDeSupported,PaperCodeId,TextBookId,ChapterId,PastExamPaperId,PastExamQuestionId,Explain,Remark");
            strSql.Append(" FROM Question ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
