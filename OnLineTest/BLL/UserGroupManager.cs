...
namespace OnLineTest.BLL
{
	...
	{
		private readonly OnLineTest.DAL.UserGroupServers dal=new OnLineTest.DAL.UserGroupServers();
		...
		{
			return dal.Exists(UserGroupName,UserGroupId);
		}
		...
		public bool Delete(string UserGroupName,int UserGroupId)
		{
			...
			return dal.Delete(UserGroupName,UserGroupId);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
        ...
        public OnLineTest.Model.UserGroup GetModel(string usergroupname)
        {
            ...
            return dal.GetModel(usergroupname);
        }

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public OnLineTest.Model.UserGroup GetModelByCache(int UserGroupId)
		{
			...
			return (OnLineTest.Model.UserGroup)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<OnLineTest.Model.UserGroup> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<OnLineTest.Model.UserGroup> DataTableToList(DataTable dt)
		{
			List<OnLineTest.Model.UserGroup> modelList = new List<OnLineTest.Model.UserGroup>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				OnLineTest.Model.UserGroup model;
